...
PROXYPATH="/afs/cern.ch/user/e/egazzarr/private/clusters/escape-gitops/proxies/" # change according to your own needs
...
export ROBOT_CLIENT_CERT=${PROXYPATH}"client.crt"
export ROBOT_CLIENT_KEY=${PROXYPATH}"client.key"
export X509_USER_PROXY=${PROXYPATH}"x509up_escape"
