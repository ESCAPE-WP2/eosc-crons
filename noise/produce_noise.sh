...
python3 ../cric-info-tools/list_rses_from_cric.py -o ../cric-info-tools/list_rses_from_cric.txt -i ../cric-info-tools/disabled_rses.txt

rses=()
while read line
do
    rses+=($line)
done < ../cric-info-tools/list_rses_from_cric.txt
